...
wp_enqueue_script( 'slick', get_template_directory_uri() . '/js/slick.js', array('jquery'), false, true);wp_enqueue_script( 'responsiveSlider', get_template_directory_uri() . '/js/responsive-slider.js', array('jquery'), false, true);
