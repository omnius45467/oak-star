...
wp_enqueue_style('nav', get_template_directory_uri().'/css/nav.css', false, false, 'all');
wp_enqueue_style('special', get_template_directory_uri().'/css/special.css', false, false, 'all');
wp_enqueue_style('events', get_template_directory_uri().'/css/events.css', false, false, 'all');
wp_enqueue_style('service', get_template_directory_uri().'/css/service.css', false, false, 'all');
...
wp_enqueue_style('ui-css', get_template_directory_uri().'/css/jquery-ui.css', false, false, 'all');
...
wp_enqueue_script( 'old_bootstrap', get_template_directory_uri() . '/js/old_bootstrap.js', array('jquery'), false, true);
...
wp_enqueue_script( 'freewall', get_template_directory_uri() . '/js/jquery.freewall.js', array('jquery'), false, true);
wp_enqueue_script( 'masonry', get_template_directory_uri() . '/js/jquery.masonry.js', array('jquery'), false, true);
...
wp_enqueue_script( 'backstreach', get_template_directory_uri() . '/js/jquery.backstreach.js', array('jquery'), false, true);
